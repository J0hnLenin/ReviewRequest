...
Ещё было бы хорошо в url запроов передавать номер версии API для обратной совместимости, если мы в будущем захотим поменять формат API. Обычно делают так: servise-user:port/api/v1/...
...
Файл спецификации с основными запросами находится тут: /docs/openapi.yml.
